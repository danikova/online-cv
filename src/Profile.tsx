import { Avatar, createStyles, Grid, makeStyles, Typography, Link } from '@material-ui/core';
  ...
  return (
    <Grid container spacing={3} className={classes.profileRoot}>
      ...
      <Grid item xs={12} sm={12} md={6}>
        ...
        <Typography>
          <FormattedMessage id="profile.dateOfBirth.key" />: <FormattedMessage id="profile.dateOfBirth.value" />
        </Typography>
        <Typography>
          <FormattedMessage id="profile.nationality.key" />: <FormattedMessage id="profile.nationality.value" />
        </Typography>
        <Typography>
