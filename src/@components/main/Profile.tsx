        ...
        <HoverContainer className="flex-auto p-8">
          <div className="flex-auto">
            <div className="min-h-full flex flex-col">
              ...
              <div className="grid grid-cols-[auto_1fr] grid-rows-5 ml-4 gap-y-2 max-lg:grid-cols-1 print:hidden">
                <ProfileGridContent />
              </div>
              <div className="hidden print:grid grid-cols-[auto_1fr] grid-rows-5 gap-y-2 gap-x-2 ">
                <ProfileGridContent />
              </div>
            </div>
          </div>
...
function ProfileGridContent() {
  return (
    <>
      ...
      <a
        href="https://www.google.com/maps/place/Budapest,+XVI.+ker%C3%BClet/@47.5191306,19.1690793,13z/"
      ...
      <a
        href="mailto:kovacs.daniel.9509@gmail.com"
        className="text-primary-900 hover:underline"
      >
